 ...
 */
type Anyvar = null | string | number | Anyvar[] | {
    type: string;
    value: any;
...
declare namespace Serialize {
  export { type Serialize_Action as Action, type Serialize_Anyvar as Anyvar, type Serialize_Authorization as Authorization, type Serialize_Contract as Contract, type Serialize_Field as Field, Serialize_SerialBuffer as SerialBuffer, type Serialize_SerializedAction as SerializedAction, type Serialize_SerializerOptions as SerializerOptions, Serialize_SerializerState as SerializerState, type Serialize_Symbol as Symbol, type Serialize_Type as Type, Serialize_arrayToHex as arrayToHex, Serialize_b64tob64u as b64tob64u, Serialize_blockTimestampToDate as blockTimestampToDate, Serialize_createAbiTypes as createAbiTypes, Serialize_createBaseResolvedTransaction as createBaseResolvedTransaction, Serialize_createInitialTypes as createInitialTypes, Serialize_createTransactionExtensionTypes as createTransactionExtensionTypes, Serialize_createTransactionTypes as createTransactionTypes, Serialize_dateToBlockTimestamp as dateToBlockTimestamp, Serialize_dateToTimePoint as dateToTimePoint, Serialize_dateToTimePointSec as dateToTimePointSec, Serialize_deserializeAction as deserializeAction, Serialize_deserializeActionData as deserializeActionData, Serialize_deserializeAnyArray as deserializeAnyArray, Serialize_deserializeAnyObject as deserializeAnyObject, Serialize_deserializeAnyvar as deserializeAnyvar, Serialize_deserializeAnyvarShort as deserializeAnyvarShort, Serialize_getType as getType, Serialize_getTypesFromAbi as getTypesFromAbi, Serialize_hexToUint8Array as hexToUint8Array, Serialize_serializeAction as serializeAction, Serialize_serializeActionData as serializeActionData, Serialize_serializeAnyArray as serializeAnyArray, Serialize_serializeAnyObject as serializeAnyObject, Serialize_serializeAnyvar as serializeAnyvar, Serialize_serializeQuery as serializeQuery, Serialize_stringToSymbol as stringToSymbol, Serialize_supportedAbiVersion as supportedAbiVersion, Serialize_symbolToString as symbolToString, Serialize_timePointSecToDate as timePointSecToDate, Serialize_timePointToDate as timePointToDate, Serialize_transactionHeader as transactionHeader };
}
...
declare namespace RpcInterfaces {
  export type { RpcInterfaces_Abi as Abi, RpcInterfaces_AbiBinToJsonResult as AbiBinToJsonResult, RpcInterfaces_AbiJsonToBinResult as AbiJsonToBinResult, RpcInterfaces_AccountResourceInfo as AccountResourceInfo, RpcInterfaces_AccountResult as AccountResult, RpcInterfaces_ActivatedProtocolFeature as ActivatedProtocolFeature, RpcInterfaces_Authority as Authority, RpcInterfaces_BlockHeader as BlockHeader, RpcInterfaces_BlockHeaderStateTaposInfo as BlockHeaderStateTaposInfo, RpcInterfaces_BlockSigningAuthority as BlockSigningAuthority, RpcInterfaces_BlockTaposInfo as BlockTaposInfo, RpcInterfaces_DBSizeGetResult as DBSizeGetResult, RpcInterfaces_DBSizeIndexCount as DBSizeIndexCount, RpcInterfaces_DeferredTransaction as DeferredTransaction, RpcInterfaces_GeneratedTransaction as GeneratedTransaction, RpcInterfaces_GetAbiResult as GetAbiResult, RpcInterfaces_GetAccountResult as GetAccountResult, RpcInterfaces_GetAccountsByAuthorizersResult as GetAccountsByAuthorizersResult, RpcInterfaces_GetActionsResult as GetActionsResult, RpcInterfaces_GetActivatedProtocolFeaturesParams as GetActivatedProtocolFeaturesParams, RpcInterfaces_GetActivatedProtocolFeaturesResult as GetActivatedProtocolFeaturesResult, RpcInterfaces_GetBlockHeaderStateResult as GetBlockHeaderStateResult, RpcInterfaces_GetBlockInfoResult as GetBlockInfoResult, RpcInterfaces_GetBlockResult as GetBlockResult, RpcInterfaces_GetCodeHashResult as GetCodeHashResult, RpcInterfaces_GetCodeResult as GetCodeResult, RpcInterfaces_GetControlledAccountsResult as GetControlledAccountsResult, RpcInterfaces_GetCurrencyStatsResult as GetCurrencyStatsResult, RpcInterfaces_GetInfoResult as GetInfoResult, RpcInterfaces_GetKeyAccountsResult as GetKeyAccountsResult, RpcInterfaces_GetProducerScheduleResult as GetProducerScheduleResult, RpcInterfaces_GetProducersResult as GetProducersResult, RpcInterfaces_GetRawAbiResult as GetRawAbiResult, RpcInterfaces_GetRawCodeAndAbiResult as GetRawCodeAndAbiResult, RpcInterfaces_GetScheduledTransactionsResult as GetScheduledTransactionsResult, RpcInterfaces_GetTableByScopeResult as GetTableByScopeResult, RpcInterfaces_GetTableByScopeResultRow as GetTableByScopeResultRow, RpcInterfaces_GetTableRowsResult as GetTableRowsResult, RpcInterfaces_GetTransactionResult as GetTransactionResult, RpcInterfaces_IncrementalMerkle as IncrementalMerkle, RpcInterfaces_KeyWeight as KeyWeight, RpcInterfaces_KycInfo as KycInfo, RpcInterfaces_KycProvider as KycProvider, RpcInterfaces_Limit as Limit, RpcInterfaces_NativeTransaction as NativeTransaction, RpcInterfaces_OrderedActionResult as OrderedActionResult, RpcInterfaces_PackedTransaction as PackedTransaction, RpcInterfaces_PackedTrx as PackedTrx, RpcInterfaces_Permission as Permission, RpcInterfaces_PermissionElement as PermissionElement, RpcInterfaces_PermissionLevel as PermissionLevel, RpcInterfaces_PermissionLevelWeight as PermissionLevelWeight, RpcInterfaces_ProcessedAction as ProcessedAction, RpcInterfaces_ProcessedTransaction as ProcessedTransaction, RpcInterfaces_ProducerAuthority as ProducerAuthority, RpcInterfaces_ProducerAuthoritySchedule as ProducerAuthoritySchedule, RpcInterfaces_ProducerDetails as ProducerDetails, RpcInterfaces_ProducerKey as ProducerKey, RpcInterfaces_ProducerScheduleType as ProducerScheduleType, RpcInterfaces_ProtocolFeatureActivationSet as ProtocolFeatureActivationSet, RpcInterfaces_PushTransactionArgs as PushTransactionArgs, RpcInterfaces_ReadOnlyTransactResult as ReadOnlyTransactResult, RpcInterfaces_RefundRequest as RefundRequest, RpcInterfaces_RequiredAuth as RequiredAuth, RpcInterfaces_ResourceDelegation as ResourceDelegation, RpcInterfaces_ResourceOverview as ResourceOverview, RpcInterfaces_RexBalance as RexBalance, RpcInterfaces_RexInfo as RexInfo, RpcInterfaces_RsaKey as RsaKey, RpcInterfaces_ScheduleInfo as ScheduleInfo, RpcInterfaces_SecurityGroupInfo as SecurityGroupInfo, RpcInterfaces_SignedBlockHeader as SignedBlockHeader, RpcInterfaces_StateExtension as StateExtension, RpcInterfaces_TraceApiAction as TraceApiAction, RpcInterfaces_TraceApiGetBlockResult as TraceApiGetBlockResult, RpcInterfaces_TraceApiTransaction as TraceApiTransaction, RpcInterfaces_TraceApiTransactionHeader as TraceApiTransactionHeader, RpcInterfaces_TransactionReceipt as TransactionReceipt, RpcInterfaces_UserInfo as UserInfo, RpcInterfaces_VoterInfo as VoterInfo, RpcInterfaces_WaKey as WaKey, RpcInterfaces_WaitWeight as WaitWeight };
}
 ...
 */
type Query = string | [string, Query[]] | [string, Anyvar, Query[]] | {
    method: string;
    arg?: Anyvar;
    filter?: Query[];
};
type ContextFreeGroupCallback = (index: {
    cfa: number;
    cfd: number;
}) => {
...
declare namespace ApiInterfaces {
  export type { ApiInterfaces_AbiProvider as AbiProvider, ApiInterfaces_AccountDelta as AccountDelta, ApiInterfaces_ActionReceipt as ActionReceipt, ApiInterfaces_ActionSerializerType as ActionSerializerType, ApiInterfaces_ActionTrace as ActionTrace, ApiInterfaces_AuthSequence as AuthSequence, ApiInterfaces_AuthorityProvider as AuthorityProvider, ApiInterfaces_AuthorityProviderArgs as AuthorityProviderArgs, ApiInterfaces_BinaryAbi as BinaryAbi, ApiInterfaces_CachedAbi as CachedAbi, ApiInterfaces_ClientDataJSON as ClientDataJSON, ApiInterfaces_ContextFreeGroupCallback as ContextFreeGroupCallback, ApiInterfaces_MsgParams as MsgParams, ApiInterfaces_Query as Query, ApiInterfaces_QueryConfig as QueryConfig, ApiInterfaces_RecoverPersonalSignature as RecoverPersonalSignature, ApiInterfaces_ResourcePayer as ResourcePayer, ApiInterfaces_SignatureProvider as SignatureProvider, ApiInterfaces_SignatureProviderArgs as SignatureProviderArgs, ApiInterfaces_SignedMsgParams as SignedMsgParams, ApiInterfaces_TransactConfig as TransactConfig, ApiInterfaces_TransactResult as TransactResult, ApiInterfaces_Transaction as Transaction, ApiInterfaces_TransactionHeader as TransactionHeader, ApiInterfaces_TransactionReceiptHeader as TransactionReceiptHeader, ApiInterfaces_TransactionTrace as TransactionTrace, ApiInterfaces_TypedData as TypedData, ApiInterfaces_TypedMessage as TypedMessage, ApiInterfaces_WaExecAction as WaExecAction };
}
...
declare namespace Numeric {
  export { type Key$1 as Key, Numeric_KeyType as KeyType, Numeric_base58ToBinary as base58ToBinary, Numeric_base64ToBinary as base64ToBinary, Numeric_binaryToBase58 as binaryToBase58, Numeric_binaryToDecimal as binaryToDecimal, Numeric_convertLegacyPublicKey as convertLegacyPublicKey, Numeric_convertLegacyPublicKeys as convertLegacyPublicKeys, Numeric_decimalToBinary as decimalToBinary, Numeric_isNegative as isNegative, Numeric_negate as negate, Numeric_privateKeyDataSize as privateKeyDataSize, Numeric_privateKeyToLegacyString as privateKeyToLegacyString, Numeric_privateKeyToString as privateKeyToString, Numeric_publicKeyDataSize as publicKeyDataSize, Numeric_publicKeyToLegacyString as publicKeyToLegacyString, Numeric_publicKeyToString as publicKeyToString, Numeric_signatureDataSize as signatureDataSize, Numeric_signatureToString as signatureToString, Numeric_signedBinaryToDecimal as signedBinaryToDecimal, Numeric_signedDecimalToBinary as signedDecimalToBinary, Numeric_stringToPrivateKey as stringToPrivateKey, Numeric_stringToPublicKey as stringToPublicKey, Numeric_stringToSignature as stringToSignature };
}
...
declare namespace Key {
  export { Key_PrivateKey as PrivateKey, Key_PublicKey as PublicKey, Key_Signature as Signature, Key_constructElliptic as constructElliptic, Key_generateKeyPair as generateKeyPair, Key_k1Ec as k1Ec, Key_r1Ec as r1Ec };
}
